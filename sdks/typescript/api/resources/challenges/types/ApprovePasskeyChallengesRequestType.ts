...
export const ApprovePasskeyChallengesRequestType = {
    PublicKey: "public-key",
} as const;
export type ApprovePasskeyChallengesRequestType =
    (typeof ApprovePasskeyChallengesRequestType)[keyof typeof ApprovePasskeyChallengesRequestType];
